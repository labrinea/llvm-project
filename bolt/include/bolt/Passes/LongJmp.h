...
class LongJmpPass : public BinaryFunctionPass {
  ...
  struct FragmentCluster {
    ...
    /// <Destination BB> -> <Thunk Function>.
    DenseMap<const BinaryBasicBlock *, BinaryFunction *> ForwardBranchThunks;
    DenseMap<const BinaryBasicBlock *, BinaryFunction *> BackwardBranchThunks;
  };
